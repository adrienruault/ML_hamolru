...
def flip_training():
    ...
    if not os.path.exists('./data/flip_training/images/'):
        os.makedirs('./data/flip_training/images/')

    if not os.path.exists('./data/flip_training/groundtruth/'):
        os.makedirs('./data/flip_training/groundtruth/')
    ...
    for i in range(TRAIN_SIZE):
        ...
        data_name = "./data/flip_training/images/satImage_%.3d" % (i*4 + 1) + '.png'
        groundtruth_name = "./data/flip_training/groundtruth/satImage_%.3d" % (i*4 + 1) + '.png'
        ...
        for j in range(3):
            ...
            data_name = "./data/flip_training/images/satImage_%.3d" % (i*4 + 2 + j) + '.png'
            groundtruth_name = "./data/flip_training/groundtruth/satImage_%.3d" % (i*4 + 2 + j) + '.png'
            misc.imsave(data_name, data_img)
            misc.imsave(groundtruth_name, groundtruth_img)
